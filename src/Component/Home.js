        ...
        <>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-sm-12 col-md-6 col-lg-7">
                            ...
                            <ul className="list">
                                <li>
                                    <div className="feature-s1">
                                        <div className="feature-icon feature-icon-s5">
                                ...
                                <li>
                                    <div className="feature-s1">
                                        ...
                                        <div className="feature-text">
                                            <p>Interest Paid Every 15 Minutes: 96 Times Daily!</p>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div className="feature-s1">
                                        ...
                                        <div className="feature-text">
                                            <p>Automatic Staking and Compounding in Your Wallet!</p>
                                        </div>
                                    </div>
                                </li>
                            </ul>
            ...
            <section className='earn-section'>
                ...
                <div className='container'>
                    <div className='row'>
                        <div className='col-sm-12 col-md-12 col-lg-12 text-center'>
                            <h4 className='section_head'>How much can I earn?</h4>
                        </div>
                    </div>
                    <div className='row align-items-center mt-5'>
                        ...
                        <div className='col-sm-12 col-md-2 col-lg-2'>
                            <div className="elementor-icon-wrapper">
                                <div className="elementor-icon elementor-animation-skew-forward">
            ...
            <section className='work-section'>
                <div className='container'>
                    <div className='row'>
                        <div className='col-sm-12 col-md-12 col-lg-12'>
                            <h3 className='section_head text-center'>How it Works</h3>
                        </div>
                    </div>
                    <div className='row mt-5'>
                                    ...
                                    <ul className="elementor-icon-list-items">
                                        <li className="elementor-icon-list-item">
                                            <span className="elementor-icon-list-icon">
                                                <i aria-hidden="true" className="fab fa-telegram"></i>						</span>
                                            <span className="elementor-icon-list-text">Join Our Telegram Community</span>
                                        </li>
                                    </ul>
                                </div>
                                <div>
                                    <a href='https://t.me/blastrr' target="_blank" rel="noreferrer" className='btn btn-primary'><i className='fab fa-rocketchat'></i> Chat Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className='safe-section'>
                ...
                <div className='container'>
                            ...
                            <ul className="list">
                                ...
                                <li>
                                    <div className="feature-s1">
                                        ...
                                        <div className="feature-text">
                                            <p>You will achieve financial freedom, faster!</p>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                    ...
                    <div className='row mt-5'>
                        <div className='col-sm-12 col-lg-12 text-center'>
                            <a href='https://t.me/blastrr' target="_blank" rel="noreferrer" className="btn btn-primary py-4 px-4 animate-btn my-5"><i className="fab fa-telegram-plane"></i> Join Our Telegram Community</a>
                        </div>
                    </div>
                </div>
            </section>
                            ...
                            <ul className="list">
                                ...
                                <li className='mb-4'>
                                    <div className="feature-s1">
                                        ...
                                        <div className="feature-text">
                                            <p>Hold: Just by holding your $BLASTRR tokens you earn rebase rewards every 15 minutes. Growing your balance at a compouded rate of 190% APY.</p>
                                        </div>
                                    </div>
                                </li>
                                <li className='mb-4'>
            ...
            <section className='tokenomics-section'>
                <div className='container'>
                    <div className='row'>
                        <div className='col-sm-12 col-md-12 col-lg-12 text-center'>
                            <h3 className='section_head mb-5'>Tokenomics</h3>
                        </div>
                    </div>
                    <div className='row'>
                        <div className='col-sm-12 col-md-6 col-lg-6'>
                        ...
                        <div className='col-sm-12 col-md-6 col-lg-6'>
                            <div className='text-center'>
                                <div className='token-icon text-danger'>
            ...
            <section className='advantages-section'>
                <div className='container'>
                    <div className='row'>
                        <div className='col-sm-12 col-md-12 col-lg-12 text-center'>
                            <h3 className='section_head mb-5'>Competitive Advantages</h3>
                        </div>
                    </div>
                    <div className='row'>
                        <div className='col-sm-12 col-md-12 col-lg-12'>
                                ...
                                <table className='table table-borderless'>
                                    <tbody>
                                        <tr>
                                            ...
                                            <th>
                                                <img src={require('../assets/images/logo.png')} alt="logo" style={{ "width": "250px", "height": "auto" }} />
                                            </th>
                                            <th>
                                                <h4>Titano</h4>
                                            </th>
                                        ...
                                        <tr>
                                            <td>
                                                <div className='d-flex align-items-center'>
                                                    ...
                                                    <span className='elementor-icon-list-text'>APY</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div className='d-flex align-items-center'>
                                                    <i aria-hidden="true" className="fas fa-hand-holding-usd tab-icon"></i>
                                                    <span className='elementor-icon-list-text'>190%</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div className='d-flex align-items-center'>
                                                    <i aria-hidden="true" className="fas fa-hand-holding-usd tab-icon"></i>
                                                    <span className='elementor-icon-list-text'>102,483.58%</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div className='d-flex align-items-center'>
                                                    <i aria-hidden="true" className="fas fa-hand-holding-usd tab-icon"></i>
                                                    <span className='elementor-icon-list-text'>158,893.59%</span>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div className='d-flex align-items-center'>
                                                    <i aria-hidden="true" className="fas fa-question-circle tab-icon"></i>
                                                    <span className='elementor-icon-list-text'>Fees</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div className='d-flex align-items-center'>
                                            ...
                                            <td>
                                                <div className='d-flex align-items-center'>
                                                    <i aria-hidden="true" className="fas fa-hand-holding tab-icon"></i>
                                                    <span className='elementor-icon-list-text'>13%/18%</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div className='d-flex align-items-center'>
                                                    <i aria-hidden="true" className="fas fa-hand-holding tab-icon"></i>
                                                    <span className='elementor-icon-list-text'>15%/25%</span>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div className='d-flex align-items-center'>
                                                    <i aria-hidden="true" className="fas fa-check tab-icon"></i>
                                                    <span className='elementor-icon-list-text'>Yes</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div className='d-flex align-items-center'>
                                                    <i aria-hidden="true" className="fas fa-times tab-icon text-danger"></i>
                                                    <span className='elementor-icon-list-text'>No</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div className='d-flex align-items-center'>
                                        ...
                                        <tr>
                                            <td>
                                                <div className='d-flex align-items-center'>
                                                    <i aria-hidden="true" className="fas fa-question-circle tab-icon"></i>
                                                    <span className='elementor-icon-list-text'>Sustainable Chart Growth</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div className='d-flex align-items-center'>
                                        ...
                                        <tr>
                                            <td>
                                                <div className='d-flex align-items-center'>
                                                    <i aria-hidden="true" className="fas fa-question-circle tab-icon"></i>
                                                    <span className='elementor-icon-list-text'>Insurance Fund</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div className='d-flex align-items-center'>
            ...
            <section className='faq-section'>
                <div className='container'>
                    <div className='row'>
                        <div className='col-sm-12 col-md-12 col-lg-12 text-center'>
                            <h3 className='section_head mb-5'>FAQ's</h3>
                        </div>
                    </div>
                    <div className='row'>
                        <div className='col-sm-12 col-lg-12'>
                            <div className="accordion" id="accordionExample">
                                ...
                                <div className="accordion-item">
                                    ...
                                    <div id="collapseFour" className="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                                        <div className="accordion-body">
                                        The cornerstone of our protocol's integrity lies in a ground-up creation, meticulously crafted by our proficient in-house developers. Unlike Titano's code or mechanisms, Blastrr stands on an entirely distinct foundation, meticulously engineered for unwavering protocol sustainability. Our distinctive portfolio comprises proprietary innovations that outshine the competition. Anchored by the ingenious Blastrr Auto-Liquidity Engine (SALE), fortified by the Blastrr Insurance Fund (BIF), and perpetuated through our Longterm Interest Cycle (LIC), our framework is fortified with impregnable defenses against malicious hacking attempts. A key to our approach is the unique tokenomics of Blastrr, distinguished by our Auto-Burn model, a conservative starting supply, and shorter 15-minute Epochs. These elements collectively steer us towards a more modest APY progression, a strategic choice that propels sustainability as our North Star, driving us forward in an era where measured growth triumphs over unsustainable surges.
                                        </div>
                                    </div>
                                </div>
                                <div className="accordion-item">
                                    ...
                                    <div id="collapseFive" className="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#accordionExample">
                                        <div className="accordion-body">
                                        The Blastrr Bank protocol stands as a paragon of innovation, distinguishing itself from peers like Titano/Libero and competitors through a comprehensively different mechanism. With a more disciplined approach, our token supply modestly rests at 325,000, paired with a judicious 2.5% auto burn rate and 48-hour automatic LP injections. The catalyst for sustainability is the rebase cycle, resetting every 15 minutes, ensuring a gradual and predictable trajectory. Ingeniously, the market's vibrancy fuels the Treasury with a 2.5-4.5% tax and concurrently enriches the Blastrr Insurance Fund by an additional 5%, surpassing the daily interest payouts. This orchestration guarantees an unswerving APY of 100%. The crux lies in the synergy between trading activity and long-term endurance; heightened daily trades bolster both the Treasury and Blastrr Insurance Fund, fortifying sustainability and nurturing prospective growth. The foundation of stability is further fortified by our exclusive Blastrr Auto-Liquidity Engine (SALE), seamlessly bolstering liquidity with an automatic 4% injection every 48 hours. This diligent choreography ensures steadfast protocol stability and perpetuates the unwavering APY throughout Blastrr's lifespan. Moreover, our pioneering LIC model is ingeniously calibrated—post the inaugural year, interest rates gradually taper, underscoring protocol resilience and enduring stability. And, anchoring this entire endeavor is the distinct ethos of the Blastrr Bank, where a deliberate decision to offer 1000x reduced profits finds its resonance—an affirmation that measured sustainability supersedes fleeting gains..
                                        </div>
                                    </div>
                                </div>
                            </div>
